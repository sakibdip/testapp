...
public class BookActivity extends ActionBarActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                ...
                break;
            case 2:
                mTitle = getString(R.string.author_title);
                break;
            case 3:
                mTitle = getString(R.string.tag_title);
                break;
            case 4:
                mTitle = getString(R.string.collection_title);
                break;
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((BookActivity) activity).onSectionAttached(
